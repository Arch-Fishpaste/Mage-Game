...
public class HostileAI : MonoBehaviour
{
    ...
    {
        isPlayerVisable = Physics.CheckSphere(transform.position, visionRange, playerLayerMask);
    ...
    private void FindPatrolPoints()
    {
        ...
        Vector3 potentialPoint = new Vector3(transform.position.x + randomX, transform.position.y + randomZ);
    ...
    {
        if (!isPlayerVisable && !isPlayerInRange)
        {
            PerformPatrol();
        }
        if (isPlayerVisable && !isPlayerInRange)
